      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 select-none">
          ...
          <motion.div
            ...
            className="relative w-[95vw] max-w-7xl bg-[#120407] border border-white/20 rounded-3xl shadow-[0_25px_80px_rgba(0,0,0,0.95)] overflow-hidden flex flex-col z-10"
          >
            {/* Header Bar */}
            ...
            {/* Main Stage: Photo width increased for an even wider presentation */}
            <div className="relative w-full bg-black/80 flex items-center justify-center overflow-hidden p-3 sm:p-6 group min-h-[400px] sm:min-h-[480px] md:min-h-[540px]">
              {currentPhoto && (
                <div className="w-full flex items-center justify-center">
                  <motion.img
                    ...
                    className="w-[92%] sm:w-[90%] md:w-[88%] max-w-6xl h-[50vh] sm:h-[56vh] md:h-[60vh] object-cover object-center rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] border border-white/10 mx-auto"
                  />
                </div>
              )}
...
""")
print("BranchPhotoLightbox.tsx width increased!")
