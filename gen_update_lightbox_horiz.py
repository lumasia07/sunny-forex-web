      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 select-none">
          ...
          <motion.div
            ...
            className="relative w-[92vw] max-w-6xl bg-[#120407] border border-white/20 rounded-3xl shadow-[0_25px_80px_rgba(0,0,0,0.95)] overflow-hidden flex flex-col z-10"
          >
            {/* Header Bar */}
            ...
            {/* Main Stage: Photo covers at least 3/4 (75%-80%+) of horizontal length */}
            <div className="relative w-full bg-black/80 flex items-center justify-center overflow-hidden p-4 sm:p-6 group min-h-[380px] sm:min-h-[460px] md:min-h-[520px]">
              {currentPhoto && (
                <div className="w-full flex items-center justify-center">
                  <motion.img
                    ...
                    className="w-[82%] sm:w-[80%] md:w-[78%] max-w-5xl h-[48vh] sm:h-[54vh] md:h-[58vh] object-cover object-center rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] border border-white/10 mx-auto"
                  />
                </div>
              )}
              ...
              {totalCount > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-3 sm:left-6 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-black/75 hover:bg-[#7A1220] text-white border border-white/25 flex items-center justify-center transition-all shadow-2xl hover:scale-110 active:scale-95 z-20"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-3 sm:right-6 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-black/75 hover:bg-[#7A1220] text-white border border-white/25 flex items-center justify-center transition-all shadow-2xl hover:scale-110 active:scale-95 z-20"
                  >
...
""")
print("BranchPhotoLightbox.tsx updated to cover 3/4 length horizontally!")
