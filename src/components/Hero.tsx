...
export function Hero({ selectedCurrency }: { selectedCurrency: string | null }) {
  return (
    <section
      className="hero-viewport relative w-full overflow-hidden bg-white"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-14 items-center py-8 lg:py-0">
          ...
          <div className="text-left order-1 relative z-10">
            <motion.h1
              ...
              className="font-display font-bold text-black text-[2rem] sm:text-[2.5rem] lg:text-[3rem] xl:text-[3.5rem] tracking-tight leading-[1.08] mb-5 max-w-xl">
              Global Reach.
              <br />
              <span className="text-black">Local Trust.</span>
              <br />
              <motion.span
            ...
            <motion.p
              ...
              className="text-[15px] sm:text-base leading-relaxed mb-7 max-w-md text-black/80">
            ...
            <motion.div
              ...
              <Link
                to="/branches"
                className="inline-flex justify-center items-center gap-3 pl-7 pr-2 py-2 rounded-full bg-white text-black border border-black/15 font-bold hover:border-[#7A1220] hover:text-[#7A1220] transition-all text-sm sm:text-base group">
                Find a Branch
