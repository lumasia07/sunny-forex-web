      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 select-none">
          ...
          >
            ...
            {/* Main Stage: Generous Height and Width filling the modal */}
            <div className="relative flex-1 w-full bg-black/80 flex items-center justify-center overflow-hidden p-2 sm:p-4 group">
              {currentPhoto && (
                <div className="w-full h-full flex items-center justify-center">
                  <motion.img
                    ...
                    className="w-[94%] sm:w-[92%] md:w-[90%] max-w-6xl h-[64vh] sm:h-[68vh] md:h-[72vh] object-cover object-center rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] border border-white/10 mx-auto"
                  />
                </div>
              )}
...
""")
print("BranchPhotoLightbox.tsx height increased significantly!")
